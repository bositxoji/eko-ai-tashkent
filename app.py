...
# =========================================================
# 2. API SOZLAMASI (XAVFSIZ USUL)
# =========================================================
# Tavsiya: API key ni .streamlit/secrets.toml ga yozing
...
with st.sidebar:
    ...
    <div class="author-box">
        ...
        <p class="author-title">Asosiy muallif:</p>
        <p class="author-name">A. ATAXOJAYEV</p>

        <p class="author-title">Ham-muallif:</p>
        <p class="author-name">SODIQJONOV SAMANDARBEK</p>

        <p class="author-title">Team:</p>
        <p class="author-name">Egamberdiev Research Group</p>
...
if page == "1. Monitoring Terminal (Asosiy)":
    ...
    st.markdown(
        '<div class="main-card">Savolingizga shafqatsiz ilmiy javob oling.</div>',
        unsafe_allow_html=True
    )
            ...
            with st.spinner("AI tahlil qilmoqda..."):
                try:
                    completion = client.chat.completions.create(
                        messages=[
                            {"role": "system", "content": "Sen Silent Threat AI ekologisan."},
                    ...
                    st.markdown(
                        f"<div class='main-card' style='border-color:#FFD400;'>"
    ...
    st.markdown(
        ...
        f'Hududingizdagi ifloslanish {age} yoshli tana uchun kritik darajada.'
        f'</div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        '<p class="danger-text">'
        "OGOHLANTIRISH: Hamma narsa ko'ringanidan ko'ra dahshatliroq."
        '</p>',
        unsafe_allow_html=True
    )
